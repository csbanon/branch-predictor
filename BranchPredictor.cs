...
// Branch Predictor is a C# program that runs a gshare branch prediction simulation,according to
// a specified number of Global Buffer Table (GBT) and Global History Record (GHR) bits.
    ...
    class BranchPredictor
    {
        ...
        public static int bitArraytoInt(BitArray bitArray)
        {
            ...
            if (bitArray.Length > 32)
                throw new ArgumentException("This number is too large. It cannot be represented ina 32-bit integer.");
